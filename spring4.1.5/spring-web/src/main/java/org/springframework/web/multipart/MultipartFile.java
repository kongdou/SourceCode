...
public interface MultipartFile {
	 ...
	 */
	byte[] getBytes() throws IOException;//将文件内容以字节数组的形式返回
	 ...
	 * @throws IOException in case of access errors (if the temporary store fails)
	 */
	InputStream getInputStream() throws IOException;// 将文件内容以输入流的形式返回
	 ...
	 */
	void transferTo(File dest) throws IOException, IllegalStateException;// 将文件内容传输到指定文件中
