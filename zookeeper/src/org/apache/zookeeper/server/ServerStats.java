...
public class ServerStats {
	//从zookeeper启动开始,或者是最近一次重置服务端统计信息后,服务端向客户端发送的响应次数
    private long packetsSent;
    //从zookeeper启动开始,或者是最近一次重置服务端统计信息后,服务端接收到来自客户端请求包的次数
    private long packetsReceived;
    //从zookeeper启动开始,或者是最近一次重置服务端统计信息后,服务端处理的最大延时
    private long maxLatency;
    //从zookeeper启动开始,或者是最近一次重置服务端统计信息后,服务端处理的最小延时
    private long minLatency = Long.MAX_VALUE;
    //从zookeeper启动开始,或者是最近一次重置服务端统计信息后,服务端处理的总延时
    private long totalLatency = 0;
    //从zookeeper启动开始,或者是最近一次重置服务端统计信息后,服务端处理的客户端总请求数
