...
public class LearnerHandler extends Thread {
    ...
    public void run() {
        try {            
            ...
            /**
             * leader接收到learner的基本信息后，会解析出该learner的ZXID
             * 然后根据Learner的ZXID解析出其对应的epoch_of_leaner，和当前的
             * leader服务器的epoch_of_leader进行比较，如果该learner的epoch_of_learner
             * 更大的话，那么就更新Leader的epoch
             */
            //leaner服务器处理的最新zxid
            long zxid = qp.getZxid();
            //leader解析leaner信息，计算新的epoch
